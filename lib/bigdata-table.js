...
/* harmony default export */ var table_body = ({
  ...
  computed: {
    ...
    timesTableData: function timesTableData() {
      ...
      //   return item.display
      // })
      var displayRows = this.data;
      if (this.table.isTree) {
        displayRows = this.data.filter(function (item) {
          return _this2.store.states.treeData[item[_this2.table.rowKey]].display === true;
        });
      }
...
/* harmony default export */ var data_handle = ({
      ...
      handler: function handler(value) {
        ...
        if (this.$ready) {
          this.$nextTick(function () {
            ...
            // this.scrollTop = 0;
            //  更新
            _this5.setComputedProps();
            //  延迟 计算滚动条是否显示
            setTimeout(function () {
              _this5.updateScrollY();
            }, 100);
          });
        }
      }
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      _this6.insideTableData = _this6.setIndex(_this6.tableData);
      // this._initM();
      _this6.resize();
    });
  }
