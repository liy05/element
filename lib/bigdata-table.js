...
"use strict";
/* harmony import */ var normalize_wheel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(31);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./packages/bigdata-table/src/table.vue?vue&type=template&id=e2111caa&
var render = function() {
  var _vm = this
    ...
    [
      ...
      _c(
        "div",
        {
          ...
          on: { DOMMouseScroll: _vm.handleScroll, scroll: _vm.handleScroll }
        },
        [
          _c(
            "div",
            [
              _c("div", { style: { height: _vm.topPlaceholderHeight + "px" } }),
              _c("render-dom", {
                style: {
                  width: _vm.layout.bodyWidth ? _vm.layout.bodyWidth + "px" : ""
                },
                attrs: {
                  render: _vm.renderTable,
                  context: _vm.context,
                  store: _vm.store,
                  stripe: _vm.stripe,
              ...
              _c("div", {
                style: { height: _vm.bottomPlaceholderHeight + "px" }
              })
            ],
            1
          ),
              ...
              _c(
                ...
                [
                  _c(
                    ...
                    [
                      _c("div", {
                        style: { height: _vm.topPlaceholderHeight + "px" }
                      }),
                      _c("render-dom", {
                        style: {
                          width: _vm.layout.bodyWidth
...
// CONCATENATED MODULE: ./packages/bigdata-table/src/table.vue?vue&type=template&id=e2111caa&
...
var mousewheel = __webpack_require__(30);
...
// CONCATENATED MODULE: ./packages/bigdata-table/src/util.js
...
// CONCATENATED MODULE: ./packages/bigdata-table/src/table-store.js
/* eslint-disable semi */
/* eslint-disable no-debugger */
...
var scrollbar_width_ = __webpack_require__(22);
var scrollbar_width_default = /*#__PURE__*/__webpack_require__.n(scrollbar_width_);

// CONCATENATED MODULE: ./packages/bigdata-table/src/table-layout.js
...
var tooltip_ = __webpack_require__(18);
var tooltip_default = /*#__PURE__*/__webpack_require__.n(tooltip_);

// CONCATENATED MODULE: ./packages/bigdata-table/src/layout-observer.js
...
// CONCATENATED MODULE: ./packages/bigdata-table/src/table-body.js
...
/* harmony default export */ var table_body = ({
  ...
  render: function render(h) {
    ...
    return h(
      ...
      [h('colgroup', [this._l(this.columns, function (column) {
        ...
        var rowKey = _this.table.rowKey ? _this.getKeyOfRow(row, _this.fvIndex($index, row)) : _this.fvIndex($index, row);
        // 树data
        var treeNode = _this.treeData[rowKey];
        var rowClasses = _this.getRowClass(row, _this.fvIndex($index, row));
        if (treeNode) {
        ...
        var tr = h(
          ...
          [_this._l(_this.columns, function (column, cellIndex) {
            ...
            if (!rowspan || !colspan) {
              ...
              if ((cellIndex === _this.firstDefaultColumnIndex || _this.treeColumnIndex.indexOf(cellIndex) >= 0) && treeNode) {
                data.treeNode = {
  ...
  computed: {
    ...
    treeColumnIndex: function treeColumnIndex() {
      var result = [];
      for (var index = 0; index < this.columns.length; index++) {
    ...
    timesTableData: function timesTableData() {
      ...
      switch (this.tableIndex) {
        case 1:
          ...
          var startIndex = count1;
          var endIndex = count1 + this.itemNum;
          // 取显示的列
          if (this.table.isTree) {
          ...
          console.log('index', { startIndex: startIndex, endIndex: endIndex });
          console.log('data', data);
          break;
        case 2:
          count2 = this.times1 * this.itemNum * 3;
          var startIndex2 = count2 + this.itemNum;
          var endIndex2 = count2 + this.itemNum * 2;
          // 取显示的列
          if (this.table.isTree) {
          ...
          console.log('index', { startIndex2: startIndex2, endIndex2: endIndex2 });
          console.log('data', data);
          break;
        case 3:
          count3 = this.times2 * this.itemNum * 3;
          var startIndex3 = count3 + this.itemNum * 2;
          var endIndex3 = count3 + this.itemNum * 3;
          // 取显示的列
          if (this.table.isTree) {
...
var tag_ = __webpack_require__(19);
var tag_default = /*#__PURE__*/__webpack_require__.n(tag_);

// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./packages/bigdata-table/src/filter-panel.vue?vue&type=template&id=514690a2&
var filter_panelvue_type_template_id_514690a2_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
...
var filter_panelvue_type_template_id_514690a2_staticRenderFns = []
filter_panelvue_type_template_id_514690a2_render._withStripped = true


// CONCATENATED MODULE: ./packages/bigdata-table/src/filter-panel.vue?vue&type=template&id=514690a2&
...
// CONCATENATED MODULE: ./packages/bigdata-table/src/dropdown.js
...
var checkbox_group_ = __webpack_require__(23);
var checkbox_group_default = /*#__PURE__*/__webpack_require__.n(checkbox_group_);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib??vue-loader-options!./packages/bigdata-table/src/filter-panel.vue?vue&type=script&lang=js&
//
//
//
//
...
// CONCATENATED MODULE: ./packages/bigdata-table/src/filter-panel.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./packages/bigdata-table/src/filter-panel.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  filter_panelvue_type_template_id_514690a2_render,
  filter_panelvue_type_template_id_514690a2_staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "packages/bigdata-table/src/filter-panel.vue"
/* harmony default export */ var filter_panel = (component.exports);
// CONCATENATED MODULE: ./packages/bigdata-table/src/table-header.js
...
// CONCATENATED MODULE: ./packages/bigdata-table/src/table-footer.js
...
// CONCATENATED MODULE: ./packages/bigdata-table/src/util/index.js
...
// CONCATENATED MODULE: ./packages/bigdata-table/src/mixins/data-handle.js
/* eslint-disable no-debugger */
...
/* harmony default export */ var data_handle = ({
  ...
  methods: {
    ...
    initGroupHeight: function initGroupHeight(data) {
      ...
      if (this.isTree && this.store.states.treeData) {
        ...
        var treeShowArr = data.filter(function (item) {
          return _this.store.states.treeData[item[_this.rowKey]].display;
        });
        var moduleNb = Math.ceil(this.height / this.rowHeight) + this.appendNum;
        var groupHeight = {};
        if (treeShowArr.length > moduleNb) {
          for (var i in treeShowArr) {
            var nb = (+i + 1) * moduleNb;
        ...
        var _moduleNb = Math.ceil(this.height / this.rowHeight) + this.appendNum;
        var _groupHeight = {};
        if (data.length > _moduleNb) {
          for (var _i in data) {
            var _nb = (+_i + 1) * _moduleNb;
            if (_nb > data.length) {
              _groupHeight[_i] = data.length % _moduleNb * this.rowHeight;
              break;
            }
            _groupHeight[_i] = _moduleNb * this.rowHeight;
          }
        } else {
          _groupHeight[0] = data.length * this.rowHeight;
        }
        return _groupHeight;
      }
    },
    ...
    _tableResize: function _tableResize() {
      ...
      this.$nextTick(function () {
        ...
        var scrollBarWidth = _this2.totalRowHeight > _this2.wrapperHeight ? getScrollbarWidth() : 0;
        _this2.outerWidth = _this2.$refs.bodyWrapper.offsetWidth - 2 - scrollBarWidth;
    ...
    getTables: function getTables(h, prop) {
      var displayRows = this.treeShowArr;
      // if (this.isTree) {
      ...
      //   });
      // }
      var table1 = this.getItemTable(h, this.table1Data, 1, prop, displayRows);
      var table2 = this.getItemTable(h, this.table2Data, 2, prop, displayRows);
      var table3 = this.getItemTable(h, this.table3Data, 3, prop, displayRows);
    ...
    //  生成body
    getItemTable: function getItemTable(h, data, index, prop, displayRows) {
      var _this3 = this;
      ...
      return h(table_body, {
        ...
        on: {
          ...
          'changeHeight': function changeHeight(index, height) {
            _this3.groupHeight[index] = height;
            //
            _this3.setComputedProps();
          }
        },
    ...
    DataResize: function DataResize() {
      var value = flattenData(this.data);
      //  重置高度分组
  ...
  computed: {
    ...
    placeholderHeight: function placeholderHeight() {
      ...
      for (var _iterator = arr, _isArray = Array.isArray(_iterator), _i2 = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
        var _ref;
    ...
    treeDataToFix: function treeDataToFix() {
      // 树形结构时，树对象，用于计算高度，和展开收缩时重新计算高度
      return this.store.states.treeData;
    },
    treeShowArr: function treeShowArr() {
      var _this4 = this;

      var treeShowArr = this.store.states.data;
      if (this.isTree && this.store.states.treeData) {
        // 去掉树收缩隐藏的列，使用this.store.states.treeData
        treeShowArr = this.store.states.data.filter(function (item) {
          return _this4.store.states.treeData[item[_this4.rowKey]].display;
        });
      }
      return treeShowArr;
    }
      ...
      handler: function handler(value) {
        ...
        if (this.$ready) {
          this.$nextTick(function () {
            ...
            // this.scrollTop = 0;
            //  更新
            _this6.setComputedProps();
            //  延迟 计算滚动条是否显示
            setTimeout(function () {
              _this6.updateScrollY();
            }, 100);
          });
        }
      }
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      _this7.insideTableData = _this7.setIndex(_this7.tableData);
      // this._initM();
      _this7.resize();
    });
  }
});
// CONCATENATED MODULE: ./packages/bigdata-table/src/dom/renderDom.js
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib??vue-loader-options!./packages/bigdata-table/src/table.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var tablevue_type_script_lang_js_ = ({
  ...
  mixins: [locale_default.a, migrating_default.a, data_handle],
    ...
    getTableTreeData: function getTableTreeData(data) {
      ...
      var traverse = function traverse(children, parentData, level) {
        children.forEach(function (item) {
          ...
          treeData[rowKey] = {
            display: _this.isTreeExpandAll,
            level: level
          };
          parentData.children.push(rowKey);
          if (Array.isArray(item.children) && item.children.length) {
            treeData[rowKey].children = [];
            treeData[rowKey].expanded = _this.isTreeExpandAll;
      ...
      if (data) {
        data.forEach(function (item) {
          ...
          var treeNode = {
            level: 0,
            expanded: _this.isTreeExpandAll,
            display: true,
            children: []
          };
          if (containChildren) {
...
// CONCATENATED MODULE: ./packages/bigdata-table/src/table.vue?vue&type=script&lang=js&
 /* harmony default export */ var src_tablevue_type_script_lang_js_ = (tablevue_type_script_lang_js_); 
// CONCATENATED MODULE: ./packages/bigdata-table/src/table.vue
...
table_component.options.__file = "packages/bigdata-table/src/table.vue"
/* harmony default export */ var src_table = (table_component.exports);
// CONCATENATED MODULE: ./packages/bigdata-table/index.js
...
/* harmony default export */ var bigdata_table = __webpack_exports__["default"] = (src_table);
